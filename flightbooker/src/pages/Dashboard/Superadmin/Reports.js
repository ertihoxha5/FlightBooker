...
const SuperadminReports = () => {
  ...
  return (
    <div className="container-fluid">
      <h4 className="mb-4 text-gray-800">Superadmin - Reports Overview</h4>
      ...
      <div className="row">
        ...
        <div className="col-md-6 col-xl-3 mb-4">
          <div className="card shadow border-left-success py-3 px-3">
            <div className="d-flex align-items-center justify-content-between">
              <div>
                <h6 className="text-success text-uppercase mb-1">Të Ardhurat</h6>
        ...
        <div className="col-md-6 col-xl-3 mb-4">
          <div className="card shadow border-left-warning py-3 px-3">
            <div className="d-flex align-items-center justify-content-between">
              <div>
                <h6 className="text-warning text-uppercase mb-1">Klientët e Rinj</h6>
      ...
      <div className="card shadow mb-4">
        <div className="card-header py-3 bg-white">
          <h6 className="m-0 font-weight-bold text-primary">Të ardhurat me kalimin e kohës</h6>
        </div>
        <div className="card-body">
          <p className="text-muted">// Chart Statik - Backend mund ta bëjë dinamik</p>
